...
export class Neo4jService {
  ...
  driver =  neo4j.driver(environment.HOST_PORT,neo4j.auth.basic(environment.USER,environment.PASSWORD),{encrypted: "ENCRYPTION_ON",trust:"TRUST_CUSTOM_CA_SIGNED_CERTIFICATES"});
